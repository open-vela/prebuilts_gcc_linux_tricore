...
__HEAP_MIN = 4K;
__CSA_SIZE = 8K;
__TRICORE_DERIVATE_MEMORY_MAP__ = 0x49A0;
...
__INT_CODE_FLASH_BANK3_BEGIN = 0x80C00000;
__INT_CODE_FLASH_BANK3_SIZE = 4M;
__INT_CODE_FLASH_BANK4_BEGIN = 0x81000000;
__INT_CODE_FLASH_BANK4_SIZE = 4M;
__INT_CODE_FLASH_BANK5_BEGIN = 0x81400000;
...
MEMORY
{
  ...
  PMU_PFLASH3 (rx!p): org = 0x80C00000, len = 4M
  PMU_PFLASH4 (rx!p): org = 0x81000000, len = 4M
  PMU_PFLASH5 (rx!p): org = 0x81400000, len = 4M
 ...
 * fit together
*/
_. = ASSERT ((__TRICORE_DERIVATE_MEMORY_MAP__ == __TRICORE_DERIVATE_NAME__), "Using wrong Memory Map. This Map is for TC49Ax");
