...
__INT_CODE_FLASH_BANK2_BEGIN = 0x80400000;
__INT_CODE_FLASH_BANK2_SIZE = 0x200000;
__INT_CODE_FLASH_BANK3_BEGIN = 0x80600000;
__INT_CODE_FLASH_BANK3_SIZE = 0x200000;
__INT_DATA_FLASH_BEGIN = 0xaf000000;
__INT_DATA_FLASH_SIZE = 768K;
...
MEMORY
{
  ...
  PMU_PFLASH2 (rx!p): org = 0x80400000, len = 0x200000
  PMU_PFLASH3 (rx!p): org = 0x80600000, len = 0x200000
  PMU_DFLASH0 (w!xp): org = 0xaf000000, len = 768K
