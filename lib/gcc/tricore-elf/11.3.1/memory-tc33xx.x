...
__HEAP_MIN = 8K;
__CSA_SIZE = 16K;
__TRICORE_DERIVATE_MEMORY_MAP__ = 0x3300;
...
MEMORY
{
  ...
  DMI_LDRAM (w!xp): org = 0xd0000000, len = 192K
 ...
 * fit together
*/
_. = ASSERT ((__TRICORE_DERIVATE_MEMORY_MAP__ == __TRICORE_DERIVATE_NAME__), "Using wrong Memory Map. This Map is for TC33xx");
