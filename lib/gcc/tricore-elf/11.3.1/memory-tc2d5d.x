...
__HEAP_MIN = 8K;
__CSA_SIZE = 16K;
__TRICORE_DERIVATE_MEMORY_MAP__ = 0x2d5d;
...
__INT_DATA_FLASH_BANK1_BEGIN = 0xaf100000;
__INT_DATA_FLASH_BANK1_SIZE = 1M;
...
MEMORY
{
  ...
  PMU_DFLASH1 (w!xp): org = 0xaf100000, len = 1M
 ...
 * fit together
*/
_. = ASSERT ((__TRICORE_DERIVATE_MEMORY_MAP__ == __TRICORE_DERIVATE_NAME__), "Using wrong Memory Map. This Map is for TC2D5D");
