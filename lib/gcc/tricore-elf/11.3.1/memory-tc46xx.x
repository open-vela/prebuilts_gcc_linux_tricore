...
__HEAP_MIN = 4K;
__CSA_SIZE = 8K;
__TRICORE_DERIVATE_MEMORY_MAP__ = 0x4600;
...
__INT_CODE_FLASH_BANK3_SIZE = 2M;
...
MEMORY
{
  ...
  PMU_PFLASH3 (rx!p): org = 0x80A00000, len = 2M
 ...
 * fit together
*/
_. = ASSERT ((__TRICORE_DERIVATE_MEMORY_MAP__ == __TRICORE_DERIVATE_NAME__), "Using wrong Memory Map. This Map is for TC46xx");
