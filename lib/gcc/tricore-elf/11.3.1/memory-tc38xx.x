...
__HEAP_MIN = 8K;
__CSA_SIZE = 16K;
__TRICORE_DERIVATE_MEMORY_MAP__ = 0x3800;
...
__INT_CODE_FLASH_BANK3_SIZE = 1M;
...
MEMORY
{
  ...
  PMU_PFLASH3 (rx!p): org = 0x80900000, len = 1M
  PMU_DFLASH0 (w!xp): org = 0xaf000000, len = 512K
 ...
 * fit together
*/
_. = ASSERT ((__TRICORE_DERIVATE_MEMORY_MAP__ == __TRICORE_DERIVATE_NAME__), "Using wrong Memory Map. This Map is for TC38xx");
